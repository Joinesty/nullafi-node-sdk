...
const Address = require('./aliases/address');
const FirstName = require('./aliases/first-name');
const LastName = require('./aliases/last-name');
const DateOfBirth = require('./aliases/date-of-birth');
const DriversLicense = require('./aliases/drivers-license');
const Gender = require('./aliases/gender');
const Passport = require('./aliases/passport');
const PlaceOfBirth = require('./aliases/place-of-birth');
const Race = require('./aliases/race');
const Random = require('./aliases/random');
const SSN = require('./aliases/ssn');
const Generic = require('./aliases/generic');
const TaxPayerID = require('./aliases/tax-payer-id');
const VehicleRegistration = require('./aliases/vehicle-registration');
