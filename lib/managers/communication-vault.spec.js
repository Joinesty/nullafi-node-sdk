...
describe('Communication Vault Service', () => {
    ...
    describe('postCommunicationVault', () => {
        it('should create a new vault and return the instance of the vault', async () => {
            ...
            const vault = await CommunicationVault.postCommunicationVault(client, payload.name, payload.tags);
    ...
    describe('getCommunicationVault', () => {
        it('should get a existing vault and return the instance of the vault', async () => {
            ...
            const client = new Client();
            const vault = await CommunicationVault.getCommunicationVault(client, response.id, masterKey);
            expect(vault).to.not.be.empty;
            expect(vault.id).to.not.be.empty;
    ...
    describe('encrypt', () => {
        it('should encrypt a info from this vault', async () => {
