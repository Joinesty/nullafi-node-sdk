...
module.exports = class Email {
    ...
    postEmail(emailAddress, tags) {
        ...
        const response = this.vault.client.post(`/vault/communication/${vaultId}/email`, {
    ...
    /**
         ...
         */
    getEmail(tokenId) {
        const response = this.vault.client.get(`/vault/communication/${vaultId}/email/${tokenId}`);
        response.emailAddress = this.vault.decrypt(response.iv, response.authTag, response.emailAddress);
        return response;
    }
    ...
    deleteEmail(vaultId, tokenId) {
        return this.vault.client.delete(`/vault/communication/${vaultId}/email/${tokenId}`);
    }
};
