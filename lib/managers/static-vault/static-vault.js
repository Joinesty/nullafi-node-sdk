...
const TaxPayer = require('../aliases/tax-payer/tax-payer');
...
class StaticVault {
    ...
    * @return {Promise}
    */
    static async deleteStaticVault(client, vaultId) {
        const response = await client.delete(`/vault/static/${vaultId}`);
        return response;
    }
};
